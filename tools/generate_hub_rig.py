...
def keyed_guild() -> Image.Image:
    image = Image.open(GUILD_SOURCE).convert("RGBA")
    data = np.array(image)
    ...
    # Suppress green spill on antialiased edge pixels without changing the
    # blue banners or natural foliage inside the building.
