    ...
    public sealed partial class JourneyTravelGameplayPrototype
    {
        ...
        private static UxmlViewContract BuildJourneyViewContract()
        {
            var contract = new UxmlViewContract("PackspireJourneyCompleteView")
                ...
                .Require<VisualElement>("journey-combat-lab")
                .Require<DropdownField>("journey-combat-lab-background")
                .Require<DropdownField>("journey-combat-lab-enemy")
                .Require<DropdownField>("journey-combat-lab-attack")
                .Require<Button>("journey-combat-lab-play")
                .Require<Button>("journey-combat-lab-close")
                .Require<Label>("journey-combat-lab-status")
