...
public static class GameCatalog {
 ...
 public static readonly Dictionary<string,CardDef> Cards=new(){
  ["basicStrike"]=C("basicStrike","基本攻撃",CardType.Attack,1,"敵に2D6 − 2ダメージ。",damage:5),["basicGuard"]=C("basicGuard","基本防御",CardType.Skill,1,"5ブロック。",block:5),["basicTactic"]=C("basicTactic","基本戦術",CardType.Skill,0,"2ブロック。",block:2),
  ["slash"]=C("slash","斬撃",CardType.Attack,1,"敵に2D6 + 0ダメージ。",damage:7),["guard"]=C("guard","防御",CardType.Skill,1,"6ブロック。",block:6),["spark"]=C("spark","火花",CardType.Power,1,"2D6 − 3ダメージ、次の攻撃+3。",damage:4,buff:3),["mend"]=C("mend","応急手当",CardType.Skill,1,"HPを4回復。",heal:4),["stab"]=C("stab","刺突",CardType.Attack,0,"敵に2D6 − 4ダメージ。",damage:3),["brace"]=C("brace","堅牢",CardType.Skill,2,"13ブロック。",block:13),["focus"]=C("focus","整流",CardType.Power,0,"エネルギー+1。",energy:1),["bomb"]=C("bomb","爆薬",CardType.Attack,2,"敵に2D6 + 8ダメージ。",damage:15,exhaust:true),["pierce"]=C("pierce","貫通突き",CardType.Attack,2,"敵に2D6 + 4ダメージ。",damage:11),["parry"]=C("parry","受け流し",CardType.Skill,0,"3ブロック。",block:3),["acid"]=C("acid","酸液",CardType.Attack,1,"敵に2D6 − 1ダメージ。",damage:6),["tailwind"]=C("tailwind","追い風",CardType.Power,1,"エネルギー+1、4ブロック。",energy:1,block:4),["devour"]=C("devour","貪食斬り",CardType.Attack,1,"2D6 + 6ダメージ、自身に2ダメージ。",damage:13,self:2),["inferno"]=C("inferno","焔断ち",CardType.Attack,2,"敵に2D6 + 11ダメージ。",damage:18),["echoWall"]=C("echoWall","反響障壁",CardType.Skill,1,"12ブロック。",block:12),["starBomb"]=C("starBomb","星喰い爆薬",CardType.Attack,2,"敵に2D6 + 17ダメージ。",damage:24,exhaust:true)
 };
